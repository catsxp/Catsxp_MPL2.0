...
#ifndef CATSXP_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
#define CATSXP_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
...
#endif  // CATSXP_COMPONENTS_COMMANDS_COMMON_ACCELERATOR_PARSING_H_
