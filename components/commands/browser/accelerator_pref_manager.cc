...
#include "catsxp/components/commands/browser/accelerator_pref_manager.h"
...
constexpr char kAcceleratorsPrefs[] = "catsxp.accelerators";
constexpr char kDefaultAcceleratorsPrefs[] = "catsxp.default_accelerators";
