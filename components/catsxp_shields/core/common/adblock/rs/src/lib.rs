...
mod ffi {
    ...
    extern "Rust" {
        type CatsxpCoreResourceStorage;
        fn new_resource_storage(resources_json: &CxxString) -> Box<CatsxpCoreResourceStorage>;
        fn new_empty_resource_storage() -> Box<CatsxpCoreResourceStorage>;
        ...
        fn has_resource_for_testing(storage: &CatsxpCoreResourceStorage, name: &CxxString) -> bool;
    }
    extern "Rust" {
        type Engine;
        ...
        fn use_resource_storage(&mut self, storage: &CatsxpCoreResourceStorage);
    ...
    unsafe extern "C++" {
        include!(
            "catsxp/components/catsxp_shields/core/common/adblock/resolver/adblock_domain_resolver.h"
        );
