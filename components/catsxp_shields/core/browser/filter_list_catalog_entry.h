...
#ifndef CATSXP_COMPONENTS_CATSXP_SHIELDS_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
#define CATSXP_COMPONENTS_CATSXP_SHIELDS_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
...
// Represents an entry of the catalog of filter lists that Catsxp makes
// available. Corresponds to the entries in
// https://github.com/catsxp/adblock-resources/blob/master/filter_lists/regional.json.
// See https://github.com/catsxp/adblock-resources#filter-list-description-format
// for details.
...
#endif  // CATSXP_COMPONENTS_CATSXP_SHIELDS_CORE_BROWSER_FILTER_LIST_CATALOG_ENTRY_H_
