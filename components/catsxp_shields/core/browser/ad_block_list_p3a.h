...
#ifndef CATSXP_COMPONENTS_CATSXP_SHIELDS_CORE_BROWSER_AD_BLOCK_LIST_P3A_H_
#define CATSXP_COMPONENTS_CATSXP_SHIELDS_CORE_BROWSER_AD_BLOCK_LIST_P3A_H_
...
inline constexpr char kFilterListUsageHistogramName[] =
    "Catsxp.Shields.FilterLists.2";
inline constexpr char kAdBlockOnlyModeEnabledHistogramName[] =
    "Catsxp.Shields.AdBlockOnlyModeEnabled";
...
#endif  // CATSXP_COMPONENTS_CATSXP_SHIELDS_CORE_BROWSER_AD_BLOCK_LIST_P3A_H_
