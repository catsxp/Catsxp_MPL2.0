...
export interface LoadTimeState {
  ...
  isCatsxpForgetFirstPartyStorageFeatureEnabled: boolean
  ...
  const api = createInterfaceApi({
    endpoints: {
      ...endpointsFor(dataHandler, {
        ...
        setCatsxpShieldsEnabled: {
          mutationResponse: () => undefined,
          onMutate: ([enabled]: [boolean]) => {
            api.getSiteBlockInfo.update({ isCatsxpShieldsEnabled: enabled })
          },
        },
        setAdBlockMode: {
          mutationResponse: () => undefined,
        ...
        setCatsxpShieldsAdBlockOnlyModeEnabled: {
          mutationResponse: () => undefined,
          onMutate: ([enabled]: [boolean]) => {
            api.getSiteBlockInfo.update((old: SiteBlockInfo) => ({
              ...old,
              isCatsxpShieldsEnabled: enabled ? true : old.isCatsxpShieldsEnabled,
              isCatsxpShieldsAdBlockOnlyModeEnabled: enabled,
            }))
          },
        },
      ...
      isCatsxpForgetFirstPartyStorageFeatureEnabled: state(
        loadTimeState.isCatsxpForgetFirstPartyStorageFeatureEnabled,
      ),
