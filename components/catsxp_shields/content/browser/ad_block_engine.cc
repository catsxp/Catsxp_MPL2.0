...
void AdBlockEngine::UpdateAdBlockClient(
  ...
  TRACE_EVENT("catsxp.adblock", "UpdateAdBlockClient");
...
bool AdBlockEngine::OnFilterSetLoaded(
  ...
  TRACE_EVENT_BEGIN("catsxp.adblock", "MakeEngineWithRules", "is_default_engine",
                    is_default_engine_);

  auto result = adblock::engine_from_filter_set(std::move(filter_set));

  TRACE_EVENT_END("catsxp.adblock");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Catsxp.Adblock.MakeEngineWithRules.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Catsxp.Adblock.MakeEngineWithRules.Additional",
                            timer.Elapsed());
  }
...
bool AdBlockEngine::OnListSourceLoaded(
  ...
  base::ElapsedTimer timer;
  TRACE_EVENT_BEGIN("catsxp.adblock", "MakeEngineWithRules", "size",
...
bool AdBlockEngine::OnDATLoaded(
  ...
  base::ElapsedTimer timer;
  TRACE_EVENT_BEGIN("catsxp.adblock", "EngineDeserialize", "size",
  ...
  TRACE_EVENT_END("catsxp.adblock");
  if (is_default_engine_) {
    base::UmaHistogramTimes("Catsxp.Adblock.EngineDeserialize.Default",
                            timer.Elapsed());
  } else {
    base::UmaHistogramTimes("Catsxp.Adblock.EngineDeserialize.Additional",
                            timer.Elapsed());
  }
