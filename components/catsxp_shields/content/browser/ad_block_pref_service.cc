...
#include "catsxp/components/catsxp_shields/content/browser/ad_block_pref_service.h"
...
inline constexpr char kLegacyFBEmbedControlType[] = "catsxp.fb_embed_default";
inline constexpr char kLegacyTwitterEmbedControlType[] =
    "catsxp.twitter_embed_default";
inline constexpr char kLegacyLinkedInEmbedControlType[] =
    "catsxp.linkedin_embed_default";
}
