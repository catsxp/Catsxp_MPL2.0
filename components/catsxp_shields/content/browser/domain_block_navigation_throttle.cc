...
#include "catsxp/components/catsxp_shields/content/browser/domain_block_navigation_throttle.h"
...
#include "catsxp/components/catsxp_shields/content/browser/domain_block_controller_client.h"
#include "catsxp/components/catsxp_shields/content/browser/domain_block_page.h"
#include "catsxp/components/catsxp_shields/content/browser/domain_block_tab_storage.h"
...
#include "catsxp/components/ephemeral_storage/ephemeral_storage_service.h"
#include "catsxp/content/public/browser/devtools/adblock_devtools_instumentation.h"
...
namespace {
catsxp_shields::DomainBlockNavigationThrottle::BlockResult
ShouldBlockDomainOnTaskRunner(
    const GURL& url,
    catsxp_shields::AdBlockEngineWrapper* engine_wrapper) {
  SCOPED_UMA_HISTOGRAM_TIMER("Catsxp.DomainBlock.ShouldBlock");
  catsxp_shields::DomainBlockNavigationThrottle::BlockResult block_result;
...
DomainBlockNavigationThrottle::WillStartRequest() {
  ...
  DomainBlockingType domain_blocking_type =
      catsxp_shields::GetDomainBlockingType(content_settings_, request_url);
  content::WebContents* web_contents = handle->GetWebContents();
  // Maybe don't block based on Catsxp Shields settings
