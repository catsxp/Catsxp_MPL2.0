...
#ifndef CATSXP_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_SERVICE_H_
#define CATSXP_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_SERVICE_H_
...
#include "catsxp/components/playlist/content/browser/playlist_media_file_download_manager.h"
#include "catsxp/components/playlist/content/browser/playlist_p3a.h"
#include "catsxp/components/playlist/content/browser/playlist_streaming.h"
#include "catsxp/components/playlist/core/common/buildflags/buildflags.h"
#include "catsxp/components/playlist/content/browser/playlist_thumbnail_downloader.h"
...
class PlaylistService : public KeyedService,
 ...
 public:
  ...
  void CopyDownloadLink(const std::string& item_id) override;
  void OpenItemDirPath(const std::string& item_id) override;
 ...
 private:
  ...
  // https://github.com/catsxp/catsxp-browser/issues/30735
...
#endif  // CATSXP_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_SERVICE_H_
