...
import {
  ...
  icon,
  elevation
} from '@catsxp/leo/tokens/css/variables'
import LeoButton from '@catsxp/leo/react/button'
...
function PlaylistHeader ({ playlistId }: { playlistId: string }) {
  ...
  if (playlist?.items.length) {
    contextualMenuItems.push({
      name: getLocalizedString('catsxpPlaylistContextMenuEdit'),
  ...
  if (contextualMenuItems && !isDefaultPlaylist) {
    contextualMenuItems.unshift({
      name: getLocalizedString('catsxpPlaylistContextMenuRenamePlaylist'),
      iconName: 'edit-box',
      onClick: () => {
    ...
    contextualMenuItems.push({
      name: getLocalizedString('catsxpPlaylistContextMenuDeletePlaylist'),
      iconName: 'trash',
      onClick: () => {
...
function NewPlaylistButton () {
  return (
    <MediumSizedButton
      ...
      kind='plain'
      fab
      title={getLocalizedString('catsxpPlaylistTooltipCreatePlaylistFolder')}
      onClick={() => {
...
function SettingButton () {
  return (
    <MediumSizedButton
      ...
      kind='plain'
      fab
      title={getLocalizedString('catsxpPlaylistTooltipOpenPlaylistSettings')}
...
function CloseButton () {
  return (
    <MediumSizedButton
      ...
      kind='plain'
      fab
      title={getLocalizedString('catsxpPlaylistTooltipClosePanel')}
