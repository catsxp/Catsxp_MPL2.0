    ...
    <Container className={className}>
      <div>
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('catsxpPlaylistTooltipPrevious')}
          kind='plain-faint'
          onClick={() => {
        ...
        <Control
          iconName='rewind-15'
          visibility='normal'
          title={getLocalizedString('catsxpPlaylistTooltipRewind')}
          kind='plain-faint'
        ...
        {isPlaying ? (
          <Control
            ...
            visibility='both'
            title={getLocalizedString('catsxpPlaylistTooltipPause')}
            kind='plain-faint'
          ...
          <Control
            ...
            visibility='both'
            title={getLocalizedString('catsxpPlaylistTooltipPlay')}
            kind='plain-faint'
        ...
        <Control
          iconName='forward-15'
          visibility='normal'
          title={getLocalizedString('catsxpPlaylistTooltipForward')}
          kind='plain-faint'
          onClick={() => videoElement && (videoElement.currentTime += 15)}
        />
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('catsxpPlaylistTooltipNext')}
          kind='plain-faint'
        ...
        <Control
          iconName='close'
          visibility='mini'
          title={getLocalizedString('catsxpPlaylistTooltipClose')}
          kind='plain-faint'
      ...
      <div>
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('catsxpPlaylistTooltipToggleMuted')}
          kind={'plain-faint'}
          onClick={() => {
        ...
        <Control
          ...
          visibility='normal'
          title={getLocalizedString('catsxpPlaylistTooltipShuffle')}
