...
#ifndef CATSXP_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_TAB_HELPER_H_
#define CATSXP_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_TAB_HELPER_H_
...
#endif  // CATSXP_COMPONENTS_PLAYLIST_CONTENT_BROWSER_PLAYLIST_TAB_HELPER_H_
