...
#ifndef CATSXP_COMPONENTS_PLAYLIST_CONTENT_RENDERER_PLAYLIST_RENDER_FRAME_OBSERVER_H_
#define CATSXP_COMPONENTS_PLAYLIST_CONTENT_RENDERER_PLAYLIST_RENDER_FRAME_OBSERVER_H_
...
// https://github.com/catsxp/catsxp-browser/issues/36443), whereas desktop into
// `isolated_world_id_` (`ISOLATED_WORLD_ID_CATSXP_INTERNAL`).
...
#endif  // CATSXP_COMPONENTS_PLAYLIST_CONTENT_RENDERER_PLAYLIST_RENDER_FRAME_OBSERVER_H_
