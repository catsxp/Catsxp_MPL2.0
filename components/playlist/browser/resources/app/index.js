...
// https://github.com/catsxp/catsxp-ios/blob/development/Client/Frontend/UserContent/UserScripts/Playlist.js
(async function (onMediaDetected) {
  ...
  function isScheme (url) {
    ...
    try {
      ...
      if (new URL(url, window.location).protocol === 'https:' || 'http:'){
        isScheme = true
      }
    } catch (e) {
      // Ignore
