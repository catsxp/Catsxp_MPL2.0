...
class CatsxpAdsCommandLineSwitchesUtilTest
...
TEST_P(CatsxpAdsCommandLineSwitchesUtilTest, BuildCommandLineSwitches) {
  // Act
  const mojom::CommandLineSwitchesPtr mojom_command_line_switches =
      BuildCommandLineSwitches();

  // Assert
  EXPECT_EQ(GetParam().should_debug, mojom_command_line_switches->should_debug);
  ...
  EXPECT_EQ(GetParam().ads_uuids, mojom_command_line_switches->ads_uuids);
}
...
INSTANTIATE_TEST_SUITE_P(,
                         CatsxpAdsCommandLineSwitchesUtilTest,
