...
class CatsxpAdsConversionsNotificationAdUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsConversionsNotificationAdUtilTest,
       AllowedToConvertViewedAdEvent) {
  // Arrange
  const AdInfo ad =
      test::BuildAd(mojom::AdType::kNotificationAd, /*use_random_uuids=*/
                    true);
