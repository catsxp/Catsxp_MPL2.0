...
class CatsxpAdsConversionsUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsConversionsUtilTest, IsAllowedToConvertNewTabPageAdEvent) {
  // Arrange
...
TEST_F(CatsxpAdsConversionsUtilTest,
...
TEST_F(CatsxpAdsConversionsUtilTest, IsAllowedToConvertNotificationAdEvent) {
  // Arrange
...
TEST_F(CatsxpAdsConversionsUtilTest, IsAllowedToConvertSearchResultAdEvent) {
  // Arrange
...
TEST_F(CatsxpAdsConversionsUtilTest, DidAdEventOccurWithinObservationWindow) {
  // Arrange
  const AdInfo ad = test::BuildAd(mojom::AdType::kNotificationAd,
                                  /*use_random_uuids=*/false);
  const AdEventInfo ad_event =
...
TEST_F(CatsxpAdsConversionsUtilTest, DidAdEventOccurOutsideObservationWindow) {
  // Arrange
  const AdInfo ad = test::BuildAd(mojom::AdType::kNotificationAd,
                                  /*use_random_uuids=*/false);
  const AdEventInfo ad_event =
