...
class CatsxpAdsConversionsNewTabPageAdUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsConversionsNewTabPageAdUtilTest, AllowedToConvertViewedAdEvent) {
  // Arrange
  const AdInfo ad =
...
TEST_F(CatsxpAdsConversionsNewTabPageAdUtilTest,
...
TEST_F(CatsxpAdsConversionsNewTabPageAdUtilTest,
       NotAllowedToConvertClickedAdEventForNonRewardsUser) {
  // Arrange
  test::DisableCatsxpRewards();
