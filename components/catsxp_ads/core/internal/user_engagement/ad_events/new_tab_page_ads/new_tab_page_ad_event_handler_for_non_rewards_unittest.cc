...
class CatsxpAdsNewTabPageAdEventHandlerIfUserHasNotJoinedCatsxpRewardsTest
...
TEST_F(CatsxpAdsNewTabPageAdEventHandlerIfUserHasNotJoinedCatsxpRewardsTest,
       FireServedEvent) {
  // Arrange
...
TEST_F(
    CatsxpAdsNewTabPageAdEventHandlerIfUserHasNotJoinedCatsxpRewardsTest,
