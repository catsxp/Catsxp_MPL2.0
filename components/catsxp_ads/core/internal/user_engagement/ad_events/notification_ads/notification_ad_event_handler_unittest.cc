...
#include "catsxp/components/catsxp_ads/core/internal/user_engagement/ad_events/notification_ads/test/notification_ad_event_handler_delegate_mock.h"
...
class CatsxpAdsNotificationAdEventHandlerTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsNotificationAdEventHandlerTest, FireServedEvent) {
  // Arrange
...
TEST_F(CatsxpAdsNotificationAdEventHandlerTest, FireViewedEvent) {
  // Arrange
  const NotificationAdInfo ad =
      test::BuildAndSaveNotificationAd(/*use_random_uuids=*/false);
...
TEST_F(CatsxpAdsNotificationAdEventHandlerTest, FireClickedEvent) {
  // Arrange
  const NotificationAdInfo ad =
      test::BuildAndSaveNotificationAd(/*use_random_uuids=*/false);
...
TEST_F(
    CatsxpAdsNotificationAdEventHandlerTest,
...
TEST_F(CatsxpAdsNotificationAdEventHandlerTest, FireDismissedEvent) {
  // Arrange
  const NotificationAdInfo ad =
      test::BuildAndSaveNotificationAd(/*use_random_uuids=*/false);
...
TEST_F(CatsxpAdsNotificationAdEventHandlerTest, FireTimedOutEvent) {
  // Arrange
  const NotificationAdInfo ad =
      test::BuildAndSaveNotificationAd(/*use_random_uuids=*/false);
...
TEST_F(CatsxpAdsNotificationAdEventHandlerTest,
