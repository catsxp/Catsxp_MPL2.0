...
#include "catsxp/components/catsxp_ads/core/internal/catalog/catalog_url_request_builder.h"
...
class CatsxpAdsCatalogUrlRequestBuilderTest : public test::TestBase {};

TEST_F(CatsxpAdsCatalogUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_mojom_url_request->url =
      GURL("https://static.ads.catsxpsoftware.com/v9/catalog");
