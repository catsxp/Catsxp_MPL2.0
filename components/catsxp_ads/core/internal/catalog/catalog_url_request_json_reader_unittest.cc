...
#include "catsxp/components/catsxp_ads/core/internal/catalog/campaign/creative_set/catalog_os_info.h"
#include "catsxp/components/catsxp_ads/core/internal/catalog/campaign/creative_set/catalog_segment_info.h"
#include "catsxp/components/catsxp_ads/core/internal/catalog/campaign/creative_set/creative/catalog_type_info.h"
#include "catsxp/components/catsxp_ads/core/internal/catalog/campaign/creative_set/creative/notification_ad/catalog_creative_notification_ad_info.h"
...
CatalogCampaignInfo BuildCatalogCampaign1() {
  ...
  catalog_creative_notification_ad.payload.target_url =
      GURL("https://catsxp.com/1/notification_ad");
  ...
  catalog_conversion.url_pattern = "https://www.catsxp.com/1/*";
...
CatalogCampaignInfo BuildCatalogCampaign2() {
  ...
  catalog_creative_notification_ad.payload.target_url =
      GURL("https://catsxp.com/2/notification_ad");
  catalog_creative_notification_ads.push_back(catalog_creative_notification_ad);
  ...
  catalog_conversion.url_pattern = "https://www.catsxp.com/2/*";
...
class CatsxpAdsCatalogUrlRequestJsonReaderTest : public test::TestBase {};

TEST_F(CatsxpAdsCatalogUrlRequestJsonReaderTest, DoNotReadCatalogWithMissingId) {
  // Act & Assert
...
TEST_F(CatsxpAdsCatalogUrlRequestJsonReaderTest, DoNotReadCatalogWithEmptyId) {
  // Act & Assert
  EXPECT_FALSE(json::reader::ReadCatalog(
      R"JSON({
        "catalogId": "",
...
TEST_F(CatsxpAdsCatalogUrlRequestJsonReaderTest,
...
TEST_F(CatsxpAdsCatalogUrlRequestJsonReaderTest, DoNotReadMalformedCatalog) {
  // Act & Assert
