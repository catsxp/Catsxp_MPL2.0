...
#ifndef CATSXP_COMPONENTS_CATSXP_ADS_CORE_INTERNAL_SERVING_TARGETING_CONDITION_MATCHER_CONDITION_MATCHER_UTIL_H_
#define CATSXP_COMPONENTS_CATSXP_ADS_CORE_INTERNAL_SERVING_TARGETING_CONDITION_MATCHER_CONDITION_MATCHER_UTIL_H_
...
// `catsxp.new_tab_page.show_catsxp_news` pref path does not exist, the browser
// was installed 3 or more days ago, the user has fewer than 7 bookmarks, the
// chosen search provider is Startpage, and both the catsxp://settings/languages
// preferred website language and the operating system language are Deutsch:
//
//  "conditionMatchers": [
//    {
//      "prefPath": "[!]:catsxp.new_tab_page.show_catsxp_news"
//    },
//    {
//      "condition": "[T≥]:3",
...
//    {
//      "condition": "[R<]:7",
//      "prefPath": "p3a.logs_constellation_prep|Catsxp.Core.BookmarkCount|value"
//    },
//    {
//      "condition": "de$",
...
//       returning one of the following values: "Catsxp", "Google", "Yandex",
...
//       environment, for the given location, i.e., "vpn.catsxp.com",
//       "search.catsxp.com", "leo.catsxp.com", or "talk.catsxp.com", and the
...
//       the user has canceled their Catsxp VPN subscription:
//
//        "conditionMatchers": [
//          {
//             "condition": "canceled",
//             "prefPath": "[virtual]:skus|production|vpn.catsxp.com|status"
//          }
//        ]
//
...
//       "catsxp_search_engine", "google_search_engine", or
...
//          {
//            "condition":
//            "[R>]:[virtual]:serp_metrics|catsxp_search_engine|time_period_storage=7d",
//            "prefPath":
...
//  catsxp://local-state and `Default/Preferences` files. Next, change a
//  catsxp://setting or enable a feature, quit the browser and then compare the
...
#endif  // CATSXP_COMPONENTS_CATSXP_ADS_CORE_INTERNAL_SERVING_TARGETING_CONDITION_MATCHER_CONDITION_MATCHER_UTIL_H_
