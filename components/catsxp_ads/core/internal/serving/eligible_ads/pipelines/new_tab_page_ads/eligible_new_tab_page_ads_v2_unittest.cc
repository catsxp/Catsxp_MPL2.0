...
class CatsxpAdsEligibleNewTabPageAdsV2Test : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test, GetAds) {
  // Arrange
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test, GetAdsForNoMatchingSegments) {
  // Arrange
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test, DoNotGetAdsForExpiredCampaign) {
  // Arrange
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test, DoNotGetAdsForFutureCampaign) {
  // Arrange
  CreativeNewTabPageAdInfo creative_ad =
      test::BuildCreativeNewTabPageAd(CreativeNewTabPageAdWallpaperType::kImage,
                                      /*should_generate_random_uuids=*/true);
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test, DoNotGetAdsIfNoEligibleAds) {
  // Act & Assert
  base::test::TestFuture<CreativeNewTabPageAdList> test_future;
  eligible_ads_->GetForUserModel(
      UserModelInfo{
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test, RoundRobinAlwaysServesASingleAd) {
  // Arrange
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test,
...
TEST_F(CatsxpAdsEligibleNewTabPageAdsV2Test, ZeroPriorityAdIsNeverServed) {
