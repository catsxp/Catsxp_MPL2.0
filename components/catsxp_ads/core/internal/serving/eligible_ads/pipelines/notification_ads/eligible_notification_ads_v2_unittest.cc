...
class CatsxpAdsEligibleNotificationAdsV2Test : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test, GetAds) {
  // Arrange
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test, GetAdsForNoMatchingSegments) {
  // Arrange
  CreativeNotificationAdInfo creative_ad_1 =
      test::BuildCreativeNotificationAd(/*use_random_uuids=*/true);
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test, DoNotGetAdsForExpiredCampaign) {
  // Arrange
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test, DoNotGetAdsForFutureCampaign) {
  // Arrange
  CreativeNotificationAdInfo creative_ad =
      test::BuildCreativeNotificationAd(/*should_generate_random_uuids=*/true);
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test, DoNotGetAdsIfNoEligibleAds) {
  // Act & Assert
  base::test::TestFuture<CreativeNotificationAdList> test_future;
  eligible_ads_->GetForUserModel(
      UserModelInfo{
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test, RoundRobinAlwaysServesASingleAd) {
  // Arrange
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test,
...
TEST_F(CatsxpAdsEligibleNotificationAdsV2Test, ZeroPriorityAdIsNeverServed) {
