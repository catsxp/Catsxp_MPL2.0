...
class CatsxpAdsCreativeAdRoundRobinTest : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(CatsxpAdsCreativeAdRoundRobinTest, UnservedAdsShouldBeEligible) {
  // Arrange
...
TEST_F(CatsxpAdsCreativeAdRoundRobinTest,
