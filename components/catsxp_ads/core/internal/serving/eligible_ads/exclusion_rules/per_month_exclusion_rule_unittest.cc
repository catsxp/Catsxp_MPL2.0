...
class CatsxpAdsPerMonthExclusionRuleTest : public test::TestBase {};

TEST_F(CatsxpAdsPerMonthExclusionRuleTest, ShouldIncludeIfThereAreNoAdEvents) {
  // Arrange
...
TEST_F(CatsxpAdsPerMonthExclusionRuleTest, ShouldIncludeIfZero) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
...
TEST_F(CatsxpAdsPerMonthExclusionRuleTest, ShouldIncludeIfDoesNotExceedCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
  creative_ad.per_month = 2;
...
TEST_F(CatsxpAdsPerMonthExclusionRuleTest,
...
TEST_F(CatsxpAdsPerMonthExclusionRuleTest, ShouldExcludeIfExceedsCap) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
  creative_ad.per_month = 2;
