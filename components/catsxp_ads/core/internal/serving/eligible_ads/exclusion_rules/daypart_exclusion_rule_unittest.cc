...
#include "catsxp/components/catsxp_ads/core/internal/serving/eligible_ads/exclusion_rules/daypart_exclusion_rule.h"
...
class CatsxpAdsDaypartExclusionRuleTest
...
INSTANTIATE_TEST_SUITE_P(CatsxpAdsTimezones,
                         CatsxpAdsDaypartExclusionRuleTest,
                         test::kTimezones,
                         test::TimezoneTestParamName);

TEST_P(CatsxpAdsDaypartExclusionRuleTest, ShouldIncludeIfNoDayparts) {
  // Arrange
...
TEST_P(CatsxpAdsDaypartExclusionRuleTest,
...
TEST_P(CatsxpAdsDaypartExclusionRuleTest, DisallowForWrongDayOfWeek) {
  // Arrange
  CreativeAdInfo creative_ad;
  creative_ad.creative_set_id = test::kCreativeSetId;
...
TEST_P(CatsxpAdsDaypartExclusionRuleTest, ShouldIncludeAtExactMidnight) {
  // Arrange
...
TEST_P(CatsxpAdsDaypartExclusionRuleTest, ShouldIncludeAtExactEndOfDay) {
  // Arrange
