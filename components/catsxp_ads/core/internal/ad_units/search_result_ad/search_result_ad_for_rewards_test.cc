...
class CatsxpAdsSearchResultAdForRewardsIntegrationTest : public test::TestBase {
 public:
  CatsxpAdsSearchResultAdForRewardsIntegrationTest()
...
TEST_F(CatsxpAdsSearchResultAdForRewardsIntegrationTest, TriggerViewedEvents) {
  // Act & Assert
...
TEST_F(CatsxpAdsSearchResultAdForRewardsIntegrationTest,
...
TEST_F(CatsxpAdsSearchResultAdForRewardsIntegrationTest, TriggerClickedEvent) {
  // Arrange
