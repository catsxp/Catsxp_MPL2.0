...
class CatsxpAdsNewTabPageAdMojomUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsNewTabPageAdMojomUtilTest, NewTabPageAdFromMojom) {
  // Arrange
...
TEST_F(CatsxpAdsNewTabPageAdMojomUtilTest, NewTabPageAdToMojom) {
  // Arrange
  const CreativeNewTabPageAdInfo creative_ad =
      test::BuildCreativeNewTabPageAd(CreativeNewTabPageAdWallpaperType::kImage,
                                      /*use_random_uuids=*/false);
...
TEST_F(CatsxpAdsNewTabPageAdMojomUtilTest, InvalidNewTabPageAdToMojom) {
  // Arrange
