...
class CatsxpAdsNotificationAdForMobileIntegrationTest : public test::TestBase {
 public:
  CatsxpAdsNotificationAdForMobileIntegrationTest()
...
TEST_F(CatsxpAdsNotificationAdForMobileIntegrationTest,
...
TEST_F(CatsxpAdsNotificationAdForMobileIntegrationTest, TriggerViewedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});
...
TEST_F(CatsxpAdsNotificationAdForMobileIntegrationTest, TriggerClickedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});
...
TEST_F(CatsxpAdsNotificationAdForMobileIntegrationTest, TriggerDismissedEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});
...
TEST_F(CatsxpAdsNotificationAdForMobileIntegrationTest, TriggerTimedOutEvent) {
  // Arrange
  const base::test::ScopedFeatureList scoped_feature_list(
      {kNotificationAdServingFeature});
