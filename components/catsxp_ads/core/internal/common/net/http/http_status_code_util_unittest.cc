...
TEST(CatsxpAdsHttpStatusCodeUtilTest, HttpStatusCodeClass) {
  // Act & Assert
...
TEST(CatsxpAdsHttpStatusCodeUtilTest, IsSuccessfulHttpStatusCode) {
  // Act & Assert
...
TEST(CatsxpAdsHttpStatusCodeUtilTest, HttpStatusCodeToString) {
  // Arrange
