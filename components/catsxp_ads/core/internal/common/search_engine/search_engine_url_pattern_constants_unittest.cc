...
TEST(CatsxpAdsSearchEngineUrlPatternConstantsTest, GetAmazonUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"
...
TEST(CatsxpAdsSearchEngineUrlPatternConstantsTest, GetGoogleUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"
...
TEST(CatsxpAdsSearchEngineUrlPatternConstantsTest, GetMojeekUrlPattern) {
  // Act & Assert
  EXPECT_EQ("https://www.mojeek.(co.uk|com)/", GetMojeekUrlPattern());
}

TEST(CatsxpAdsSearchEngineUrlPatternConstantsTest, GetWikipediaUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"
...
TEST(CatsxpAdsSearchEngineUrlPatternConstantsTest, GetYahooUrlPattern) {
  // Act & Assert
  EXPECT_EQ(
      "https://"
