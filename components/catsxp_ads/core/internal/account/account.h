...
#ifndef CATSXP_COMPONENTS_CATSXP_ADS_CORE_INTERNAL_ACCOUNT_ACCOUNT_H_
#define CATSXP_COMPONENTS_CATSXP_ADS_CORE_INTERNAL_ACCOUNT_ACCOUNT_H_
...
class Account final : public AdsClientNotifierObserver,
 ...
 private:
  ...
  void NotifyDidInitializeWallet(const WalletInfo& wallet);
  void NotifyFailedToInitializeWallet();

  void NotifyDidProcessDeposit(const TransactionInfo& transaction);
...
#endif  // CATSXP_COMPONENTS_CATSXP_ADS_CORE_INTERNAL_ACCOUNT_ACCOUNT_H_
