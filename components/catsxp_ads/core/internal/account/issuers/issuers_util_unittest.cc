...
class CatsxpAdsIssuersUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsIssuersUtilTest, IsIssuersValid) {
  // Arrange
...
TEST_F(CatsxpAdsIssuersUtilTest, IsIssuersInvalid) {
  // Arrange
  const IssuersInfo issuers = test::BuildIssuers(
      /*ping=*/7'200'000,
      /*confirmation_token_issuer_public_keys=*/
...
TEST_F(CatsxpAdsIssuersUtilTest, HasIssuers) {
  // Arrange
...
TEST_F(CatsxpAdsIssuersUtilTest, DoesNotHaveIssuers) {
  // Act & Assert
  EXPECT_FALSE(HasIssuers());
}

TEST_F(CatsxpAdsIssuersUtilTest, HasIssuersChanged) {
  // Arrange
  test::BuildAndSetIssuers();
...
TEST_F(CatsxpAdsIssuersUtilTest, HasIssuersChangedOnInitialFetch) {
  // Arrange
  const IssuersInfo issuers = test::BuildIssuers(
      /*ping=*/3'600'000,
      /*confirmation_token_issuer_public_keys=*/
...
TEST_F(CatsxpAdsIssuersUtilTest, HasIssuersNotChanged) {
  // Arrange
  test::BuildAndSetIssuers();
