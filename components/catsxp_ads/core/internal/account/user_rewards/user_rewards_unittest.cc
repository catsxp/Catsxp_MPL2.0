...
class CatsxpAdsUserRewardsTest : public AdsClientMock, public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsUserRewardsTest, FetchIssuers) {
  // Arrange
...
TEST_F(CatsxpAdsUserRewardsTest, DoNotFetchInvalidIssuers) {
  // Arrange
  test::MockTokenGenerator(/*count=*/50);
...
TEST_F(CatsxpAdsUserRewardsTest, DoNotFetchMissingIssuers) {
  // Arrange
...
TEST_F(CatsxpAdsUserRewardsTest, RefillConfirmationTokens) {
  // Arrange
  test::BuildAndSetIssuers();
...
TEST_F(CatsxpAdsUserRewardsTest, RedeemPaymentTokens) {
  // Arrange
  const test::URLResponseMap url_responses = {
...
TEST_F(CatsxpAdsUserRewardsTest,
