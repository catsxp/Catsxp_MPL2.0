...
#include "catsxp/components/catsxp_ads/core/internal/account/utility/refill_confirmation_tokens/url_requests/request_signed_tokens/request_signed_tokens_url_request_builder.h"
...
class CatsxpAdsRequestSignedTokensUrlRequestBuilderTest : public test::TestBase {
};

TEST_F(CatsxpAdsRequestSignedTokensUrlRequestBuilderTest, BuildUrl) {
  // Arrange
  ...
  expected_mojom_url_request->url = GURL(
      R"(https://mywallet.ads.catsxpsoftware.com/v3/confirmation/token/27a39b2f-9b2e-4eb0-bbb2-2f84447496e7)");
