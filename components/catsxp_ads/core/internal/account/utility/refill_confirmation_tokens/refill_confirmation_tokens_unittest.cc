...
#include "catsxp/components/catsxp_ads/core/internal/account/utility/refill_confirmation_tokens/test/refill_confirmation_tokens_delegate_mock.h"
...
class CatsxpAdsRefillConfirmationTokensTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsRefillConfirmationTokensTest, RefillConfirmationTokens) {
  // Arrange
...
TEST_F(CatsxpAdsRefillConfirmationTokensTest,
