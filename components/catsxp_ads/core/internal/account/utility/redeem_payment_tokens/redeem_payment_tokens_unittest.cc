...
#include "catsxp/components/catsxp_ads/core/internal/account/utility/redeem_payment_tokens/test/redeem_payment_tokens_delegate_mock.h"
#include "catsxp/components/catsxp_ads/core/internal/account/utility/redeem_payment_tokens/test/redeem_payment_tokens_test_util.h"
...
class CatsxpAdsRedeemPaymentTokensTest : public test::TestBase {
 protected:
  CatsxpAdsRedeemPaymentTokensTest()
...
TEST_F(CatsxpAdsRedeemPaymentTokensTest, RedeemPaymentTokens) {
  // Arrange
...
TEST_F(CatsxpAdsRedeemPaymentTokensTest, RedeemPaymentTokensMultipleTimes) {
  // Arrange
  const test::URLResponseMap url_responses = {
      {BuildRedeemPaymentTokensUrlPath(test::kWalletPaymentId),
       {{net::HTTP_OK, test::BuildRedeemPaymentTokensUrlResponseBody()},
...
TEST_F(CatsxpAdsRedeemPaymentTokensTest, ScheduleNextTokenRedemption) {
  // Arrange
  const test::URLResponseMap url_responses = {
      {BuildRedeemPaymentTokensUrlPath(test::kWalletPaymentId),
       {{net::HTTP_OK, test::BuildRedeemPaymentTokensUrlResponseBody()}}}};
...
TEST_F(CatsxpAdsRedeemPaymentTokensTest, NoPaymentTokens) {
  // Arrange
  test::SetProfileTimePrefValue(prefs::kNextPaymentTokenRedemptionAt,
                                test::Now());
...
TEST_F(CatsxpAdsRedeemPaymentTokensTest, Retry) {
  // Arrange
  const test::URLResponseMap url_responses = {
      {BuildRedeemPaymentTokensUrlPath(test::kWalletPaymentId),
