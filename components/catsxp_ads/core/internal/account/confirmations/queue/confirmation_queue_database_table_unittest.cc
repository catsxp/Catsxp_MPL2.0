...
class CatsxpAdsConfirmationQueueDatabaseTableTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsConfirmationQueueDatabaseTableTest, SaveEmptyConfirmationQueue) {
  // Act
...
TEST_F(CatsxpAdsConfirmationQueueDatabaseTableTest, SaveConfirmationQueueItems) {
  // Arrange
...
TEST_F(CatsxpAdsConfirmationQueueDatabaseTableTest,
...
TEST_F(CatsxpAdsConfirmationQueueDatabaseTableTest, RetryConfirmationQueueItem) {
  // Arrange
  test::MockTokenGenerator(/*count=*/1);
  test::RefillConfirmationTokens(/*count=*/1);
