...
#include "catsxp/components/catsxp_ads/core/internal/account/confirmations/queue/confirmation_queue_database_table_util.h"
...
class CatsxpAdsConfirmationQueueDatabaseTableUtilTest : public ::testing::Test {
};

TEST_F(CatsxpAdsConfirmationQueueDatabaseTableUtilTest,
