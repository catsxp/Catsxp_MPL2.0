...
class CatsxpAdsConfirmationUserDataBuilderTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsConfirmationUserDataBuilderTest, BuildConfirmationUserData) {
  // Arrange
...
TEST_F(CatsxpAdsConfirmationUserDataBuilderTest,
