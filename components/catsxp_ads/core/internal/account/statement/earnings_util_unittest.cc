...
class CatsxpAdsEarningsUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsEarningsUtilTest, GetUnreconciledEarnings) {
  // Arrange
...
TEST_F(CatsxpAdsEarningsUtilTest, GetUnreconciledEarningsForNoTransactions) {
  // Act & Assert
  EXPECT_DOUBLE_EQ(0.0, GetUnreconciledEarnings(/*transactions=*/{}));
}

TEST_F(CatsxpAdsEarningsUtilTest, GetReconciledEarningsForThisMonth) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
...
TEST_F(CatsxpAdsEarningsUtilTest,
...
TEST_F(CatsxpAdsEarningsUtilTest, GetReconciledEarningsForPreviousMonth) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
