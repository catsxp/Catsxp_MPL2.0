...
class CatsxpAdsAdsSummaryUtilTest : public test::TestBase {};

TEST_F(
    CatsxpAdsAdsSummaryUtilTest,
    GetAdsSummaryForDateRangeWhenUserHasJoinedCatsxpRewardsAndNotConnectedWallet) {
  // Arrange
...
TEST_F(
    CatsxpAdsAdsSummaryUtilTest,
    GetAdsSummaryForDateRangeWhenUserHasJoinedCatsxpRewardsAndConnectedWallet) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
...
TEST_F(CatsxpAdsAdsSummaryUtilTest, DoNotGetAdsSummaryForDateRange) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("5 November 2020"));
...
TEST_F(CatsxpAdsAdsSummaryUtilTest, GetAdsSummaryForNoTransactions) {
  // Act
  const base::flat_map<mojom::AdType, int32_t> ads_summary =
