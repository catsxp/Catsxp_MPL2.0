...
class CatsxpAdsStatementTest : public test::TestBase {};

TEST_F(CatsxpAdsStatementTest, GetForTransactionsThisMonth) {
  // Arrange
...
TEST_F(CatsxpAdsStatementTest, GetForTransactionsSplitOverTwoYears) {
  // Arrange
  TransactionList transactions;
...
TEST_F(CatsxpAdsStatementTest, GetForNoTransactions) {
  // Arrange
  AdvanceClockTo(test::TimeFromString("18 November 2020"));
...
TEST_F(CatsxpAdsStatementTest, GetWithFilteredTransactions) {
  // Arrange
