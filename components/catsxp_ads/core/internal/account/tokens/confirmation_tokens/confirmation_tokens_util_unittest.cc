...
class CatsxpAdsConfirmationTokenUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsConfirmationTokenUtilTest, GetConfirmationToken) {
  // Arrange
...
TEST_F(CatsxpAdsConfirmationTokenUtilTest, DoNotGetConfirmationToken) {
  // Act & Assert
  EXPECT_FALSE(MaybeGetConfirmationToken());
}

TEST_F(CatsxpAdsConfirmationTokenUtilTest, AddConfirmationTokens) {
  // Arrange
  const ConfirmationTokenList confirmation_tokens =
...
TEST_F(CatsxpAdsConfirmationTokenUtilTest, RemoveConfirmationToken) {
  // Arrange
  const ConfirmationTokenList confirmation_tokens =
...
TEST_F(CatsxpAdsConfirmationTokenUtilTest, ConfirmationTokenCount) {
  // Arrange
