...
class CatsxpAdsAdHistoryItemValueUtilTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsAdHistoryItemValueUtilTest, AdHistoryItemFromDict) {
  // Arrange
...
TEST_F(CatsxpAdsAdHistoryItemValueUtilTest, AdHistoryItemFromLegacyDict) {
  // Arrange
...
TEST_F(CatsxpAdsAdHistoryItemValueUtilTest, AdHistoryItemToDict) {
  // Arrange
