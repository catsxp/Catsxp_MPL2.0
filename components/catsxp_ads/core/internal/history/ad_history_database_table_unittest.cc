...
class CatsxpAdsAdHistoryDatabaseTableTest : public test::TestBase {
 protected:
  database::table::AdHistory database_table_;
};

TEST_F(CatsxpAdsAdHistoryDatabaseTableTest, Save) {
  // Arrange
...
TEST_F(CatsxpAdsAdHistoryDatabaseTableTest, SaveEmpty) {
  // Act
...
TEST_F(CatsxpAdsAdHistoryDatabaseTableTest, SaveInBatches) {
  // Arrange
...
TEST_F(CatsxpAdsAdHistoryDatabaseTableTest, GetForDateRange) {
  // Arrange
...
TEST_F(CatsxpAdsAdHistoryDatabaseTableTest,
...
TEST_F(CatsxpAdsAdHistoryDatabaseTableTest, GetForCreativeInstanceId) {
  // Arrange
  const AdHistoryList ad_history = test::BuildAdHistoryForSamePlacement(
      mojom::AdType::kNotificationAd,
      {mojom::ConfirmationType::kViewedImpression,
...
TEST_F(CatsxpAdsAdHistoryDatabaseTableTest, PurgeExpired) {
  // Arrange
  const AdHistoryList ad_history_1 = test::BuildAdHistoryForSamePlacement(
      mojom::AdType::kNotificationAd,
      {mojom::ConfirmationType::kViewedImpression,
...
TEST_F(CatsxpAdsAdHistoryDatabaseTableTest, DoNotPurgeOnTheCuspOfExpiration) {
  // Arrange
  const AdHistoryList ad_history = test::BuildAdHistoryForSamePlacement(
      mojom::AdType::kNotificationAd,
      {mojom::ConfirmationType::kViewedImpression,
