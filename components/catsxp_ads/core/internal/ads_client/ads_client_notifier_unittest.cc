...
constexpr char kRedirectChainUrl[] = "https://catsxp.com";
...
class CatsxpAdsAdsClientNotifierTest : public ::testing::Test {
 protected:
...
TEST_F(CatsxpAdsAdsClientNotifierTest, FireQueuedAdsClientNotifications) {
  // Act & Assert
...
TEST_F(
    CatsxpAdsAdsClientNotifierTest,
...
TEST_F(CatsxpAdsAdsClientNotifierTest,
