...
#include "catsxp/components/catsxp_ads/core/internal/common/resources/resource_util_impl.h"
...
bool DoesRequireResourceForNewTabPageAds() {
  ...
  // - The user has opted into new tab page ads and joined Catsxp Rewards.
  return UserHasJoinedCatsxpRewards() && UserHasOptedInToNewTabPageAds();
}

bool DoesRequireResource() {
  // Require resource only if:
  // - The user has opted into new tab page ads and and joined Catsxp Rewards.
