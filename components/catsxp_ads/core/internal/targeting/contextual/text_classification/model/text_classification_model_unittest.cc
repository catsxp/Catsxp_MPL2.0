...
class CatsxpAdsTextClassificationModelTest : public test::TestBase {
 protected:
  void SetUp() override {
    test::TestBase::SetUp();
...
TEST_F(CatsxpAdsTextClassificationModelTest,
...
TEST_F(CatsxpAdsTextClassificationModelTest, DoNotGetSegmentsForEmptyText) {
  // Arrange
...
TEST_F(CatsxpAdsTextClassificationModelTest, DoNotGetSegmentsIfNeverProcessed) {
  // Arrange
  ads_client_notifier_.NotifyResourceComponentDidChange(
      test::kLanguageComponentManifestVersion, test::kLanguageComponentId);
  ASSERT_TRUE(resource_->IsLoaded());
