...
class CatsxpAdsNormalizationTransformationTest : public test::TestBase {};

TEST_F(CatsxpAdsNormalizationTransformationTest, WrongInputDataTest) {
  // Arrange
...
TEST_F(CatsxpAdsNormalizationTransformationTest, NormalizationTest) {
  // Arrange
...
TEST_F(CatsxpAdsNormalizationTransformationTest, ChainingTest) {
  // Arrange
