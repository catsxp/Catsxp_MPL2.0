...
class CatsxpAdsHashedNGramsTransformationTest : public test::TestBase {};

TEST_F(CatsxpAdsHashedNGramsTransformationTest, WrongInputDataTest) {
  // Arrange
...
TEST_F(CatsxpAdsHashedNGramsTransformationTest, HashingTest) {
  // Arrange
...
TEST_F(CatsxpAdsHashedNGramsTransformationTest, CustomHashingTest) {
  // Arrange
