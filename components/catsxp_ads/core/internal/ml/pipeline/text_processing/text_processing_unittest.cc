...
#include "catsxp/components/catsxp_ads/core/internal/ml/pipeline/test/linear_pipeline_test_util.h"
...
class CatsxpAdsTextProcessingTest : public test::TestBase {};

TEST_F(CatsxpAdsTextProcessingTest, BuildSimplePipeline) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, TestLoadFromValue) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, InitValidLinearModelTest) {
  // Arrange
  const base::FilePath path =
...
TEST_F(CatsxpAdsTextProcessingTest, InitValidNeuralModelTest) {
  // Arrange
  const base::FilePath path =
...
TEST_F(CatsxpAdsTextProcessingTest, EmptySegmentModelTest) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, EmptyTransformationsModelTest) {
  // Arrange
  const std::string input_text = "This is a spam email.";
...
TEST_F(CatsxpAdsTextProcessingTest, WrongTransformationsOrderModelTest) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, MissingRequiredFieldModelTest) {
  // Arrange
  const base::FilePath path =
...
TEST_F(CatsxpAdsTextProcessingTest, InvalidModelTest) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, kNotExistingFile) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, NotInitializedFileTest) {
  // Arrange
  pipeline::TextProcessing text_processing_pipeline;
...
TEST_F(CatsxpAdsTextProcessingTest, WrongLanguageModelTest) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, TopPredUnitTest) {
  // Arrange
...
TEST_F(CatsxpAdsTextProcessingTest, TextCMCCrashTest) {
  // Arrange
