...
class CatsxpAdsNeuralTest : public test::TestBase {
 public:
...
TEST_F(CatsxpAdsNeuralTest, Prediction) {
  // Arrange
...
TEST_F(CatsxpAdsNeuralTest, PredictionNomatrices) {
  // Arrange
  constexpr double kTolerance = 1e-6;
...
TEST_F(CatsxpAdsNeuralTest, PredictionDefaultPostMatrixFunctions) {
  // Arrange
  constexpr double kTolerance = 1e-6;
...
TEST_F(CatsxpAdsNeuralTest, TopPredictions) {
  // Arrange
  constexpr double kTolerance = 1e-6;
