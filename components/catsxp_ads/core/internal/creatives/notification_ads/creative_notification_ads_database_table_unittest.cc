...
class CatsxpAdsCreativeNotificationAdsDatabaseTableTest : public test::TestBase {
 protected:
  database::table::CreativeNotificationAds database_table_;
};

TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest, SaveEmpty) {
  // Act
...
TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest, Save) {
  // Arrange
...
TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest, SaveInBatches) {
  // Arrange
...
TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest, DoNotSaveDuplicates) {
  // Arrange
  const CreativeNotificationAdList saved_creative_ads =
...
TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest, GetForSegments) {
  // Arrange
...
TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest, GetForEmptySegments) {
  // Arrange
  const CreativeNotificationAdList saved_creative_ads =
      test::BuildCreativeNotificationAds(/*count=*/1);
  database::SaveCreativeNotificationAds(saved_creative_ads);
...
TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest,
...
TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableTest, GetNonExpired) {
  // Arrange
  CreativeNotificationAdInfo creative_ad_1 =
      test::BuildCreativeNotificationAd(/*use_random_uuids=*/true);
