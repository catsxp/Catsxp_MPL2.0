...
#include "catsxp/components/catsxp_ads/core/internal/creatives/notification_ads/creative_notification_ads_database_table_util.h"
...
class CatsxpAdsCreativeNotificationAdsDatabaseTableUtilTest
    : public ::testing::Test {};

TEST_F(CatsxpAdsCreativeNotificationAdsDatabaseTableUtilTest,
