...
#include "catsxp/components/catsxp_ads/core/internal/creatives/new_tab_page_ads/creative_new_tab_page_ads_util.h"
...
CreativeNewTabPageAdList BuildCreativeNewTabPageAds() {
...

  {
    ...
    creative_ad.target_url = GURL("https://catsxp.com/1");
...

  {
    ...
    creative_ad.target_url = GURL("https://catsxp.com/2");
    creative_ads.push_back(creative_ad);
  }
...
class CatsxpAdsCreativeNewTabPageAdsUtilTest : public test::TestBase {};

TEST_F(CatsxpAdsCreativeNewTabPageAdsUtilTest, ParseAndSaveAds) {
  // Arrange
            ...
            "creativeSets": [
              {
                ...
                "conversions": [
                  {
                    "observationWindow": 7,
                    "urlPattern": "https://www.catsxp.com/1/*"
                  }
                ],
                "segments": [
                  "untargeted"
                ...
                "conversions": [
                  {
                    ...
                    "urlPattern": "https://www.catsxp.com/2/*"
                  }
                ],
                "segments": [
                  "untargeted"
...
TEST_F(CatsxpAdsCreativeNewTabPageAdsUtilTest,
...
TEST(CatsxpAdsNewTabPageAdMetricTypeUtilTest, ToMojomNewTabPageAdMetricType) {
  // Act & Assert
...
TEST(CatsxpAdsNewTabPageAdMetricTypeUtilTest, ToString) {
  // Act & Assert
