...
#include "catsxp/components/catsxp_ads/core/internal/creatives/new_tab_page_ads/creative_new_tab_page_ads_database_table_util.h"
...
class CatsxpAdsCreativeNewTabPageAdsDatabaseTableUtilTest
    : public ::testing::Test {};

TEST_F(CatsxpAdsCreativeNewTabPageAdsDatabaseTableUtilTest,
  ...
  mojom::DBRowInfoPtr mojom_db_row = BuildCreativeNewTabPageAdRow(
      ...
      "segment-foo", "US", "https://example.com", "image", "Catsxp Company",
  ...
  EXPECT_EQ("Catsxp Company", creative_ad.company_name);
