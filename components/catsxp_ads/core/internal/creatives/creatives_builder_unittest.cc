...
#include "catsxp/components/catsxp_ads/core/internal/creatives/creatives_builder.h"
...
class CatsxpAdsCreativesBuilderTest : public test::TestBase {};

TEST_F(CatsxpAdsCreativesBuilderTest, BuildCreativesFromEmptyCatalog) {
  // Arrange
...
TEST_F(CatsxpAdsCreativesBuilderTest, BuildCreatives) {
  // Arrange
...
TEST_F(CatsxpAdsCreativesBuilderTest,
...
TEST_F(CatsxpAdsCreativesBuilderTest, BuildCreativesIncludesValidConversion) {
  // Arrange
  CatalogCreativeNotificationAdInfo creative;
  creative.instance_id = test::kCreativeInstanceId;
