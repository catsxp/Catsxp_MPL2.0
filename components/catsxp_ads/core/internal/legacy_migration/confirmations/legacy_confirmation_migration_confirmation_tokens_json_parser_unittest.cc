...
#include "catsxp/components/catsxp_ads/core/internal/legacy_migration/confirmations/legacy_confirmation_migration_confirmation_tokens_json_parser.h"
...
class CatsxpAdsLegacyConfirmationMigrationConfirmationTokensJsonParserTest
    : public ::testing::Test {
 protected:
  base::test::TaskEnvironment task_environment_;
};

TEST_F(CatsxpAdsLegacyConfirmationMigrationConfirmationTokensJsonParserTest,
