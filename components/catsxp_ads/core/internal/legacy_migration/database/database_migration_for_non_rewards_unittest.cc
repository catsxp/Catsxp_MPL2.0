...
class CatsxpAdsDatabaseMigrationForNonRewardsTest
...
TEST_P(CatsxpAdsDatabaseMigrationForNonRewardsTest, MigrateFromSchema) {
...
INSTANTIATE_TEST_SUITE_P(
    ,
    CatsxpAdsDatabaseMigrationForNonRewardsTest,
    ::testing::Range(
