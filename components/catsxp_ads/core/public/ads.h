...
#ifndef CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_H_
#define CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_H_
...
#endif  // CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_H_
