...
#ifndef CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_H_
#define CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_H_
...
class AdsClient {
 public:
  ...
  // Called to notify pending observers.
...
#endif  // CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_H_
