...
#ifndef CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
#define CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
...
class AdsClientNotifierObserver : public base::CheckedObserver {
 public:
  ...
  // Called when the Catsxp Rewards wallet did update.
...
#endif  // CATSXP_COMPONENTS_CATSXP_ADS_CORE_PUBLIC_ADS_CLIENT_ADS_CLIENT_NOTIFIER_OBSERVER_H_
