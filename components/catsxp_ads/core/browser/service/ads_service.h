...
#ifndef CATSXP_COMPONENTS_CATSXP_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_H_
#define CATSXP_COMPONENTS_CATSXP_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_H_
...
// AdsService is the key interface for the Catsxp Ads component, managing ad
...
// Note: This header can be included even when Catsxp Ads is disabled by build
// flag. When Catsxp Ads is disabled, the pointer to AdsService should be
...
#endif  // CATSXP_COMPONENTS_CATSXP_ADS_CORE_BROWSER_SERVICE_ADS_SERVICE_H_
