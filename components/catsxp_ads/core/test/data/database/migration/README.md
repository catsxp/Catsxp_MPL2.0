...
> [!IMPORTANT]
> The script currently disables foreign keys while mocking the database. This could potentially mask issues related to foreign key constraints during testing. See https://github.com/catsxp/catsxp-browser/issues/40017.
