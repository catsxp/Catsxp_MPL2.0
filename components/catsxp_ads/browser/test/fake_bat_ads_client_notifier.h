...
#ifndef CATSXP_COMPONENTS_CATSXP_ADS_BROWSER_TEST_FAKE_BAT_ADS_CLIENT_NOTIFIER_H_
#define CATSXP_COMPONENTS_CATSXP_ADS_BROWSER_TEST_FAKE_BAT_ADS_CLIENT_NOTIFIER_H_
...
#endif  // CATSXP_COMPONENTS_CATSXP_ADS_BROWSER_TEST_FAKE_BAT_ADS_CLIENT_NOTIFIER_H_
