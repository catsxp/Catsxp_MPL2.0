...
// Fake CatsxpComponent::Delegate that captures the ready_callback so tests can
...
class FakeComponentUpdaterDelegate
 ...
 public:
  ...
  void AddObserver(
      catsxp_component_updater::CatsxpComponent::ComponentObserver*) override {}
  void RemoveObserver(
      catsxp_component_updater::CatsxpComponent::ComponentObserver*) override {}
 ...
 private:
  catsxp_component_updater::CatsxpComponent::ReadyCallback ready_callback_;
  std::string locale_;
};
...
class CatsxpAdsResourceComponentRegistrarTest : public testing::Test {
 protected:
  void SetUp() override {
...
TEST_F(CatsxpAdsResourceComponentRegistrarTest,
...
TEST_F(CatsxpAdsResourceComponentRegistrarTest, IgnoresUnsupportedResourceId) {
