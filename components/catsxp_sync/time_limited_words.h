...
#ifndef CATSXP_COMPONENTS_CATSXP_SYNC_TIME_LIMITED_WORDS_H_
#define CATSXP_COMPONENTS_CATSXP_SYNC_TIME_LIMITED_WORDS_H_
...
#endif  // CATSXP_COMPONENTS_CATSXP_SYNC_TIME_LIMITED_WORDS_H_
