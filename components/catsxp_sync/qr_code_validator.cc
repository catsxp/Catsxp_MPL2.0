...
#include "catsxp/components/catsxp_sync/qr_code_validator.h"
...
#include "catsxp/components/catsxp_sync/qr_code_data.h"
...
bool QrCodeDataValidator::IsValidSeedHex(const std::string& seed_hex) {
  ...
  std::string sync_code_words =
      catsxp_sync::crypto::PassphraseFromBytes32(bytes);
