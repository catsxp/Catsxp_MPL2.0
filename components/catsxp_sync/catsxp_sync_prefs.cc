...
constexpr char kSyncV2Seed[] = "catsxp_sync_v2.seed";
constexpr char kSyncFailedDecryptSeedNoticeDismissed[] =
    "catsxp_sync_v2.failed_decrypt_seed_notice_dismissed";
constexpr char kSyncAccountDeletedNoticePending[] =
    "catsxp_sync_v2.account_deleted_notice_pending";
constexpr char kSyncLeaveChainDetails[] =
    "catsxp_sync_v2.diag.leave_chain_details";

// Deprecated
// ============================================================================
constexpr char kSyncSeed[] = "catsxp_sync.seed";
constexpr char kSyncEnabled[] = "catsxp_sync.enabled";
constexpr char kSyncDeviceId[] = "catsxp_sync.device_id";
constexpr char kSyncDeviceIdV2[] = "catsxp_sync.device_id_v2";
constexpr char kSyncDeviceObjectId[] = "catsxp_sync.device_object_id";
constexpr char kSyncPrevSeed[] = "catsxp_sync.previous_seed";
constexpr char kSyncDeviceName[] = "catsxp_sync.device_name";
constexpr char kSyncBookmarksBaseOrder[] = "catsxp_sync.bookmarks_base_order";
constexpr char kSyncBookmarksEnabled[] = "catsxp_sync.bookmarks_enabled";
constexpr char kSyncSiteSettingsEnabled[] = "catsxp_sync.site_settings_enabled";
constexpr char kSyncHistoryEnabled[] = "catsxp_sync.history_enabled";
constexpr char kSyncLatestRecordTime[] = "catsxp_sync.latest_record_time";
constexpr char kSyncLatestDeviceRecordTime[] =
    "catsxp_sync.latest_device_record_time";
constexpr char kSyncLastFetchTime[] = "catsxp_sync.last_fetch_time";
constexpr char kSyncLastCompactTimeBookmarks[] =
    "catsxp_sync.last_compact_time.bookmarks";
constexpr char kSyncDeviceList[] = "catsxp_sync.device_list";
constexpr char kSyncApiVersion[] = "catsxp_sync.api_version";
constexpr char kSyncMigrateBookmarksVersion[] =
    "catsxp_sync.migrate_bookmarks_version";
constexpr char kSyncRecordsToResend[] = "catsxp_sync_records_to_resend";
constexpr char kSyncRecordsToResendMeta[] =
    "catsxp_sync_records_to_resend_meta";
constexpr char kDuplicatedBookmarksRecovered[] =
    "catsxp_sync_duplicated_bookmarks_recovered";
constexpr char kDuplicatedBookmarksMigrateVersion[] =
    "catsxp_sync_duplicated_bookmarks_migrate_version";
constexpr char kSyncV1Migrated[] = "catsxp_sync_v2.v1_migrated";
constexpr char kSyncV1MetaInfoCleared[] = "catsxp_sync_v2.v1_meta_info_cleared";
constexpr char kSyncV2MigrateNoticeDismissed[] =
    "catsxp_sync_v2.migrate_notice_dismissed";
// ============================================================================
