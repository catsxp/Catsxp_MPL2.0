...
#include "catsxp/components/catsxp_sync/catsxp_sync_p3a.h"

#include "base/test/metrics/histogram_tester.h"
#include "components/sync/base/user_selectable_type.h"
#include "testing/gtest/include/gtest/gtest.h"

namespace catsxp_sync::p3a {

TEST(CatsxpSyncP3ATest, TestEnabledTypes) {
...
TEST(CatsxpSyncP3ATest, TestSyncedObjectsCount) {
  base::HistogramTester histogram_tester;
...
TEST(CatsxpSyncP3ATest, TestSyncCodeMonitor) {
  base::HistogramTester histogram_tester;
