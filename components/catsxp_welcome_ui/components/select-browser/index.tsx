...
import BrowserSVG from '../svg/browser-icons/browser'
import CatsxpSVG from '../svg/browser-icons/catsxp'
    ...
    <S.MainBox>
      <div className="view-header-box">
        <div className="view-details">
          <h1 className="view-title">{getLocale('catsxpWelcomeImportSettingsTitle')}</h1>
          <p className="view-desc">{getLocale('catsxpWelcomeImportSettingsDesc')}</p>
        </div>
      </div>
      <S.BrowserListBox>
      ...
      <S.ActionBox>
        ...
        >
          ...
          <Button
            ...
            size="large"
          >
            {getLocale('catsxpWelcomeImportButtonLabel')}
          </Button>
      </S.ActionBox>
    </S.MainBox>
  )
