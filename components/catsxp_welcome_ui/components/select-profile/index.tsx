    ...
    <S.MainBox>
      <div className="view-header-box">
        <div className="view-header-actions">
          <button className="back-button" onClick={handleBackButton}>
            <LeftArrowSVG />
            <span>{getLocale('catsxpWelcomeBackButtonLabel')}</span>
          </button>
        </div>
        <div className="view-details">
          <h1 className="view-title">{getLocale('catsxpWelcomeSelectProfileLabel')}</h1>
          <p className="view-desc">{getLocale('catsxpWelcomeSelectProfileDesc')}</p>
        </div>
      </div>
      <S.ProfileListBox>
        <div className="profile-list">
          <div className="list-actions">
            <div className="right">
              <button onClick={selectAll}>{getLocale('catsxpWelcomeSelectAllButtonLabel')}</button>
            </div>
          </div>
      ...
      <S.ActionBox>
        <Button
          ...
          size="large"
        >
          {getLocale('catsxpWelcomeImportProfilesButtonLabel')}
        </Button>
      </S.ActionBox>
    </S.MainBox>
  )
