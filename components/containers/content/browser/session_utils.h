...
#ifndef CATSXP_COMPONENTS_CONTAINERS_CONTENT_BROWSER_SESSION_UTILS_H_
#define CATSXP_COMPONENTS_CONTAINERS_CONTENT_BROWSER_SESSION_UTILS_H_
...
#endif  // CATSXP_COMPONENTS_CONTAINERS_CONTENT_BROWSER_SESSION_UTILS_H_
