...
#include "base/uuid.h"
#include "catsxp/components/containers/core/mojom/containers.mojom-shared.h"
#include "catsxp/components/containers/core/mojom/containers.mojom.h"
#include "catsxp/third_party/bip39wally-core-native/include/wally_bip39.h"
...
SkColor PickTemporaryContainerBackground() {
  ...
  // Keep in sync with
  // catsxp/browser/resources/settings/catsxp_content_page/background_colors.ts.
