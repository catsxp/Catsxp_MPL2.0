...
#ifndef CATSXP_COMPONENTS_CONTAINERS_CORE_BROWSER_DEFAULT_CONTAINERS_LIST_H_
#define CATSXP_COMPONENTS_CONTAINERS_CORE_BROWSER_DEFAULT_CONTAINERS_LIST_H_
...
#endif  // CATSXP_COMPONENTS_CONTAINERS_CORE_BROWSER_DEFAULT_CONTAINERS_LIST_H_
