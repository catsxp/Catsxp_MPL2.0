...
#ifndef CATSXP_COMPONENTS_CONTAINERS_CORE_BROWSER_PREFS_H_
#define CATSXP_COMPONENTS_CONTAINERS_CORE_BROWSER_PREFS_H_
...
#endif  // CATSXP_COMPONENTS_CONTAINERS_CORE_BROWSER_PREFS_H_
