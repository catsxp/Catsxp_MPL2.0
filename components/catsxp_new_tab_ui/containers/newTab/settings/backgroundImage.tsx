...
import catsxpBackground from './assets/catsxp-background.png'
...
import { RANDOM_SOLID_COLOR_VALUE, RANDOM_GRADIENT_COLOR_VALUE, MAX_CUSTOM_IMAGE_BACKGROUNDS } from 'gen/catsxp/components/catsxp_new_tab_ui/catsxp_new_tab_page.mojom.m.js'
...
class BackgroundImageSettings extends React.PureComponent<Props, State> {
  ...
  onClickCatsxpBackground = () => {
    this.props.setCatsxpBackground('')
  }
  ...
  render () {
    ...
    const usingCatsxpBackground = !usingCustomImageBackground && !selectedBackgroundColor
          ...
          <div>
            ...
            {showBackgroundImage && featureCustomBackgroundEnabled && (
              <StyledCustomBackgroundSettings>
                ...
                <StyledCustomBackgroundOption
                  onClick={this.onClickCatsxpBackground}
                >
                  <StyledSelectionBorder selected={usingCatsxpBackground}>
                    <StyledCustomBackgroundOptionImage image={catsxpBackground} selected={usingCatsxpBackground}/>
                  </StyledSelectionBorder>
                  <StyledCustomBackgroundOptionLabel>
                    {getLocale('catsxpBackgroundImageOptionTitle')}
                  </StyledCustomBackgroundOptionLabel>
                </StyledCustomBackgroundOption>
                <StyledCustomBackgroundOption
