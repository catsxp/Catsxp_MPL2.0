  ...
  switch (action.type) {
    case types.NEW_TAB_SET_INITIAL_DATA:
      ...
      state = {
        ...
        catsxpRewardsSupported: initialDataPayload.catsxpRewardsSupported,
        catsxpTalkSupported: initialDataPayload.catsxpTalkSupported,
      ...
      if (state.brandedWallpaper && !state.brandedWallpaper.isSponsored) {
        ...
        state = {
          ...state,
          featureFlagCatsxpNTPSponsoredImagesWallpaper: false
        }
      }
    ...
    case types.BACKGROUND_UPDATED:
      ...
      // custom or catsxp default background. Branded wallpaper will
      ...
      if (!state.backgroundWallpaper && background?.catsxp) {
        state.backgroundWallpaper = {
          type: 'catsxp',
          author: background.catsxp.author,
          link: background.catsxp.link.url,
          wallpaperImageUrl: background.catsxp.imageUrl.url,
          random: false
        }
      }
