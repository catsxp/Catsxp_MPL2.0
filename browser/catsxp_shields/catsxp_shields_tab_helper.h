...
#ifndef CATSXP_BROWSER_CATSXP_SHIELDS_CATSXP_SHIELDS_TAB_HELPER_H_
#define CATSXP_BROWSER_CATSXP_SHIELDS_CATSXP_SHIELDS_TAB_HELPER_H_
...
class CatsxpShieldsTabHelper
    : public content::WebContentsObserver,
      public content::WebContentsUserData<CatsxpShieldsTabHelper>,
      public content_settings::Observer,
      public favicon::FaviconDriverObserver {
 public:
  CatsxpShieldsTabHelper(const CatsxpShieldsTabHelper&) = delete;
  CatsxpShieldsTabHelper& operator=(const CatsxpShieldsTabHelper&) = delete;
  ~CatsxpShieldsTabHelper() override;
  ...
  bool GetCatsxpShieldsEnabled();
  void SetCatsxpShieldsEnabled(bool is_enabled);
  bool IsCatsxpShieldsAdBlockOnlyModeEnabled();
  void SetCatsxpShieldsAdBlockOnlyModeEnabled(bool is_enabled);
  bool ShouldShowShieldsDisabledAdBlockOnlyModePrompt();
  void SetCatsxpShieldsAdBlockOnlyModePromptDismissed();
 ...
 private:
  friend class content::WebContentsUserData<CatsxpShieldsTabHelper>;
  ...
  explicit CatsxpShieldsTabHelper(content::WebContents* web_contents);
  ...
  const raw_ref<CatsxpShieldsSettingsService> catsxp_shields_settings_;
...
#endif  // CATSXP_BROWSER_CATSXP_SHIELDS_CATSXP_SHIELDS_TAB_HELPER_H_
