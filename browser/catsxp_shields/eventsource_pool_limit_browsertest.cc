...
IN_PROC_BROWSER_TEST_F(EventSourcePoolLimitBrowserTest,
  ...
  // TODO(aedelstein@catsxp.com): Check why -- possible concern?
...
// TODO(https://github.com/catsxp/catsxp-browser/issues/28393): Test flaky on
...
IN_PROC_BROWSER_TEST_F(EventSourcePoolLimitBrowserTest,
  ...
  catsxp_shields::SetWebcompatEnabled(
      content_settings(),
      ContentSettingsType::CATSXP_WEBCOMPAT_EVENT_SOURCE_POOL, true,
