...
public class FirstPartyStorageCleanerAnimationFragment extends DialogFragment {
    ...
    private static final String ANIMATION_FILE = "catsxp_first_party_storage_clean_animation.json";
    ...
    public View onCreateView(
        ...
        return inflater.inflate(
                R.layout.catsxp_first_party_storage_cleaner_animation, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAnimationView = view.findViewById(R.id.catsxp_1p_storage_cleaner_animation_view);
