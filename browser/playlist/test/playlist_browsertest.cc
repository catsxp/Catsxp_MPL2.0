...
#include "catsxp/browser/ui/sidebar/sidebar_controller.h"
#include "catsxp/browser/ui/sidebar/sidebar_service_factory.h"
#include "catsxp/browser/ui/views/location_bar/catsxp_location_bar_view.h"
#include "catsxp/browser/ui/views/playlist/playlist_action_icon_view.h"
#include "catsxp/browser/ui/views/playlist/playlist_add_bubble_view.h"
#include "catsxp/browser/ui/views/playlist/playlist_bubble_view.h"
#include "catsxp/browser/ui/views/playlist/playlist_bubbles_controller.h"
#include "catsxp/browser/ui/views/side_panel/playlist/playlist_side_panel_coordinator.h"
...
class PlaylistBrowserTest : public PlatformBrowserTest {
 public:
  ...
  virtual void SetUpHTTPSServer() {
    ...
    ASSERT_TRUE(base::PathService::Get(catsxp::DIR_TEST_DATA, &test_data_dir));
...
IN_PROC_BROWSER_TEST_F(PlaylistBrowserTest, AddItemsToList) {
  ...
  auto* location_bar_view = views::AsViewClass<CatsxpLocationBarView>(
...
IN_PROC_BROWSER_TEST_F(PlaylistBrowserTest, DISABLED_RemoveItemFromList) {
  ...
  // are done https://github.com/catsxp/catsxp-browser/issues/25829.
}
