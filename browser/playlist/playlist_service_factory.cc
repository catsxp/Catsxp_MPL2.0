...
#else
#include "catsxp/browser/ui/catsxp_browser.h"
#include "catsxp/browser/ui/sidebar/sidebar_service_factory.h"
#include "catsxp/components/sidebar/browser/sidebar_service.h"
...
#include "catsxp/browser/playlist/playlist_data_source.h"
#endif
...
PlaylistServiceFactory::BuildServiceInstanceForBrowserContext(
  ...
  auto service = std::make_unique<PlaylistService>(
      ...
      catsxp_stats::GetFirstRunTime(local_state));
