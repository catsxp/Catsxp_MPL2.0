...
class CatsxpStatsHelperBrowserTest : public PlatformBrowserTest {
 public:
  CatsxpStatsHelperBrowserTest() = default;
 ...
 protected:
  ...
  CatsxpStatsHelper* catsxp_stats_helper() const {
    return g_catsxp_browser_process->ads_catsxp_stats_helper();
  }

  base::HistogramTester histogram_tester_;
};

IN_PROC_BROWSER_TEST_F(CatsxpStatsHelperBrowserTest,
...
IN_PROC_BROWSER_TEST_F(CatsxpStatsHelperBrowserTest, ProfileSwitch) {
...
IN_PROC_BROWSER_TEST_F(CatsxpStatsHelperBrowserTest, MultiProfileEnabledUpdate) {
  base::FilePath profile_one_path;
  Profile& profile_one = CreateProfile(profile_one_path);
  profile_one.GetPrefs()->SetBoolean(prefs::kOptedInToNotificationAds, true);
...
IN_PROC_BROWSER_TEST_F(CatsxpStatsHelperBrowserTest,
  ...
  catsxp_stats_helper()->SetFirstRunTimeForTesting(base::Time::Now() -
                                                  base::Minutes(45));
