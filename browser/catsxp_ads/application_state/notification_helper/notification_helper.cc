...
#if BUILDFLAG(IS_MAC)
#include "catsxp/browser/catsxp_ads/application_state/notification_helper/notification_helper_impl_mac.h"
#endif  // BUILDFLAG(IS_MAC)

#if BUILDFLAG(IS_WIN)
#include "catsxp/browser/catsxp_ads/application_state/notification_helper/notification_helper_impl_win.h"
...
NotificationHelper::NotificationHelper() {
  TRACE_EVENT("catsxp.ads", "NotificationHelper::NotificationHelper");
#if BUILDFLAG(IS_ANDROID)
...
bool NotificationHelper::ShowOnboardingNotification() {
  TRACE_EVENT("catsxp.ads", "NotificationHelper::ShowOnboardingNotification");
