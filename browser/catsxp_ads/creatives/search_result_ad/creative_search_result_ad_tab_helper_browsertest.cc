...
#include "catsxp/browser/catsxp_ads/creatives/search_result_ad/creative_search_result_ad_tab_helper.h"
...
// npm run test -- catsxp_browser_tests
// --filter=CatsxpAdsCreativeSearchResultAdTabHelperTest*

namespace catsxp_ads {

namespace {

constexpr std::string_view kAllowedDomain = "search.catsxp.com";
constexpr std::string_view kNotAllowedDomain = "catsxp.com";
...
constexpr char kSearchResultUrlPath[] =
    "/catsxp_ads/creative_search_result_ad.html";
...
class CatsxpAdsCreativeSearchResultAdTabHelperTest
 ...
 public:
  void SetUpOnMainThread() override {
    ...
    https_server_.RegisterRequestHandler(base::BindRepeating(
        &CatsxpAdsCreativeSearchResultAdTabHelperTest::HandleRequest,
        base::Unretained(this)));

    const base::FilePath test_data_file_path =
        base::PathService::CheckedGet(catsxp::DIR_TEST_DATA);
...
IN_PROC_BROWSER_TEST_F(CatsxpAdsCreativeSearchResultAdTabHelperTest,
                       NotAllowedDomain) {
...
IN_PROC_BROWSER_TEST_F(CatsxpAdsCreativeSearchResultAdTabHelperTest,
  ...
  const GURL url =
      GetURL(kAllowedDomain, "/catsxp_ads/invalid_creative_search_result_ad");
  ASSERT_TRUE(ui_test_utils::NavigateToURL(browser(), url));
  content::WebContents* web_contents =
      browser()->tab_strip_model()->GetActiveWebContents();
  EXPECT_EQ(url, web_contents->GetVisibleURL());
...
class SampleCatsxpAdsCreativeSearchResultAdTabHelperTest
    : public CatsxpAdsCreativeSearchResultAdTabHelperTest {
 public:
...
IN_PROC_BROWSER_TEST_F(SampleCatsxpAdsCreativeSearchResultAdTabHelperTest,
