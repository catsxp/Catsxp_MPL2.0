...
public class CatsxpAdsOnboardingFragment extends Fragment implements FirstRunFragment {
    ...
    public CatsxpAdsOnboardingFragment() {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_catsxp_ads_onboarding, container, false);
    ...
    private void startCountdown() {
        CatsxpOnboardingNotification.cancelOnboardingNotification();
