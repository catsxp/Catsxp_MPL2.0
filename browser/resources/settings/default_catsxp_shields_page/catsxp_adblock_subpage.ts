...
import './components/catsxp_adblock_editor.js'
import './components/catsxp_adblock_scriptlet_list.js'
import './components/catsxp_adblock_subscribe_dropdown.js'
...
import {getTemplate} from './catsxp_adblock_subpage.html.js'
...
class AdBlockSubpage extends AdBlockSubpageBase {
  ...
  static get observers() {
    return [
      'updateState_(prefs.catsxp.ad_block.developer_mode.value, customFilters_, customScriptlets_)'
    ]
  }
  ...
  private browserProxy_: CatsxpAdblockBrowserProxy =
    CatsxpAdblockBrowserProxyImpl.getInstance()
  ...
  override ready() {
    ...
    this.browserProxy_.addWebUiListener(
      'catsxp_adblock.onGetListSubscriptions', (value: SubscriptionInfo[]) => {
        this.subscriptionList_ = value
    })
    this.browserProxy_.addWebUiListener(
      'catsxp_adblock.onCustomFiltersChanged',
      (value: string) => {
        this.customFilters_ = value
      }
    )
