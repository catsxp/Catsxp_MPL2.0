...
} from 'gen/catsxp/components/catsxp_ads/core/mojom/catsxp_ads.mojom.m.js'
...
export interface BackgroundState {
  ...
  catsxpBackgrounds: CatsxpBackground[]
...
export function getCurrentBackground(
  ...
  switch (type) {
    case SelectedBackgroundType.kCatsxp: {
      const catsxpBackground = chooseIndex(catsxpBackgrounds, rotateIndex)
      return catsxpBackground ? { type: 'catsxp', ...catsxpBackground } : null
    }
