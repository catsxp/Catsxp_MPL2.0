...
#ifndef CATSXP_BROWSER_CONTAINERS_CONTAINERS_SERVICE_DELEGATE_H_
#define CATSXP_BROWSER_CONTAINERS_CONTAINERS_SERVICE_DELEGATE_H_
...
#endif  // CATSXP_BROWSER_CONTAINERS_CONTAINERS_SERVICE_DELEGATE_H_
