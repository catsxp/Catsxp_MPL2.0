...
#include "catsxp/browser/ntp_background/new_tab_takeover_infobar_delegate.h"

#include "catsxp/components/catsxp_rewards/core/pref_names.h"
#include "catsxp/components/ntp_background_images/browser/new_tab_takeover_infobar_util.h"
#include "catsxp/components/ntp_background_images/common/infobar_constants.h"
...
class NewTabTakeoverInfoBarDelegateTest
 ...
 public:
  ...
  void SetRewardsEnabled(bool enabled) {
    GetPrefs()->SetBoolean(catsxp_rewards::prefs::kEnabled, enabled);
  }
