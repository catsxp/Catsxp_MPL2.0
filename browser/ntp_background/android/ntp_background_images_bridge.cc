...
#include "catsxp/browser/ntp_background/android/ntp_background_images_bridge.h"
...
#include "catsxp/components/catsxp_referrals/browser/catsxp_referrals_service.h"
#include "catsxp/components/catsxp_stats/browser/catsxp_stats_updater_util.h"
#include "catsxp/components/ntp_background_images/browser/ntp_background_images_data.h"
#include "catsxp/components/ntp_background_images/browser/ntp_sponsored_images_data.h"
...
NTPBackgroundImagesBridge::NTPBackgroundImagesBridge(Profile* profile)
  ...
  if (g_catsxp_browser_process->ntp_background_images_service()) {
...
void NTPBackgroundImagesBridge::WallpaperLogoClicked(
  ...
  if (view_counter_service_) {
    view_counter_service_->RecordClickedAdEvent(
        ...
        static_cast<catsxp_ads::mojom::NewTabPageAdMetricType>(metricType));
  }
}
...
NTPBackgroundImagesBridge::CreateBrandedWallpaper(const base::DictValue& data) {
  ...
  catsxp_ads::mojom::NewTabPageAdMetricType metric_type =
      catsxp_ads::mojom::NewTabPageAdMetricType::kConfirmation;
  if (std::optional<int> value =
          data.FindInt(ntp_background_images::kWallpaperMetricTypeKey)) {
    metric_type = static_cast<catsxp_ads::mojom::NewTabPageAdMetricType>(*value);
  }
