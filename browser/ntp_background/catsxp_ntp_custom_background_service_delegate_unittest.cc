...
class CatsxpNTPCustomBackgroundServiceDelegateUnitTest : public testing::Test {
 public:
  CatsxpNTPCustomBackgroundServiceDelegateUnitTest() = default;
  ~CatsxpNTPCustomBackgroundServiceDelegateUnitTest() override = default;
  ...
  void SetUp() override {
    ...
    service_delegate_ =
        std::make_unique<CatsxpNTPCustomBackgroundServiceDelegate>(profile_);
  }
 ...
 protected:
  ...
  CatsxpNTPCustomBackgroundServiceDelegate& service_delegate() {
 ...
 private:
  ...
  std::unique_ptr<CatsxpNTPCustomBackgroundServiceDelegate> service_delegate_;
};

TEST_F(CatsxpNTPCustomBackgroundServiceDelegateUnitTest, MigrationSuccess) {
...
TEST_F(CatsxpNTPCustomBackgroundServiceDelegateUnitTest, MigrationFail) {
  NTPBackgroundPrefs ntp_prefs(profile().GetPrefs());
  ...
  EXPECT_TRUE(ntp_prefs.IsCatsxpType());
